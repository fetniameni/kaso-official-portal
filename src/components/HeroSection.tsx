      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="mb-8 animate-fade-up">
          <img
            src={kasoLogo}
            alt="Kaso - كاسو"
            className="w-64 md:w-80 h-auto mx-auto animate-pulse-glow"
          />
        </div>

        {/* Tagline */}
        <h1 
          className="rtl-text text-2xl md:text-4xl lg:text-[42px] font-bold text-foreground leading-relaxed mb-10 animate-fade-up opacity-0 animation-delay-200"
        >
