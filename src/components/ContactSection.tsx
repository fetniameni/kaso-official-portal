        ...
        <div className="mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {musicPlatforms.map((platform) => (
              ...
              >
                <div 
                  className="w-[60px] h-[60px] rounded-full bg-card border border-border/50 flex items-center justify-center transition-all duration-300 group-hover:shadow-[0_0_20px_hsl(24_100%_50%/0.5)] group-hover:border-primary/50"
